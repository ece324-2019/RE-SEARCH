...
""" This script takes all the scraped data from different stores and resizes them, renames them
    and saves these images to a test folder. This assumes data is stored in store_name folders
    and subfolders indicating the labels """
