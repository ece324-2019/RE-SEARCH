...
# urls = [['https://www.kohls.com/catalog/womens-henley-tops-clothing.jsp?CN=Gender:Womens+Neckline:Henley+Category:Tops+Department:Clothing&S=2&PPP=120&pfm=search%20visual%20nav%20refine&kls_sbp=30202820972503232343190607550603629498','vneck']]
urls = []
for comb in combos:
...
for perm in urls:
    ...
    for k in range(1,2):
        ...
        pics = []
        imgs = soup.findAll('a',{'class':'js-show-modal'})
